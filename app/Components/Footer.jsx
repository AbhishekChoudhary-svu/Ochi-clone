...
const Footer = () => {
  return (
    <div  className="w-full h-screen pt-16 relative flex rounded-tl-2xl">
      <div className="w-1/2 ">
        <h1 className='text-white text-[7vw] leading-[6vw] -tracking-[0.5vw] font-["Founders Grotesk"] font-semibold mx-16 '>
          EYE-
        </h1>
        <h1 className='text-white text-[7vw] leading-[6vw] -tracking-[0.5vw] font-["Founders Grotesk"] font-semibold mx-16  '>
          OPENING
        </h1>
        <div className="logo text-white absolute bottom-10 left-20">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2 pb-16">
        ...
        <div className="h-1/2">
          <h1 className='text-white text-[7vw] leading-[6vw] -tracking-[0.5vw] font-["Founders Grotesk"] font-semibold '>
            PRESENTATIONS
          </h1>
          <div className="text-white mx-2 mt-10 text-md">
        ...
        <div className="h-1/2 flex">
          <div className="w-2/3">
            <div className="text-white mx-2 text-md">
              <p className="mb-7">L:</p>
              <p>202-1965 W 4th Ave</p>
              <p className="mb-5">Vancouver, Canada</p>
              <p>30 Chukarina St</p>
              <p>Lviv, Ukraine</p>
              <p className="mt-10 mb-5 ">E:</p>
        ...
        <div className="w-full text-gray-400 flex justify-between pr-10">
            <h4>&copy;ochi design 2024. Legal Terms</h4>
            <h4 >Website by Abhishek</h4>
        </div>
      </div>
    </div>
  );
